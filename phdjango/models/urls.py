...
urlpatterns = [
    ...
    url(r'^model-run-config/(?P<model_run_config_id>[0-9]+)/edit/raw-firm/$', run_config_views.edit_model_run_config_firm_raw, name='model-run-config-edit-firm_config'),
    url(r'^model-run-config/(?P<model_run_config_id>[0-9]+)/edit/capital-firm/$', run_config_views.edit_model_run_config_firm_capital, name='model-run-config-edit-firm_config'),
    url(r'^model-run-config/(?P<model_run_config_id>[0-9]+)/edit/production-firm/$', run_config_views.edit_model_run_config_firm_production, name='model-run-config-edit-firm_config'),
